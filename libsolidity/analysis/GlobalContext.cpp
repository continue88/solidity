...
m_magicVariables(vector<shared_ptr<MagicVariableDeclaration const>>{
	...
	make_shared<MagicVariableDeclaration>("aes_decode", make_shared<FunctionType>(strings{"bytes32", "string"}, strings{ "bytes32" }, FunctionType::Kind::AESDecode, true, StateMutability::Pure)),
