...
const std::map<std::string, Instruction> dev::solidity::c_instructions =
{
	...
	{ "AESENCODE", Instruction::AESENCODE },
	{ "AESDECODE", Instruction::AESDECODE },
...
{ //												Add, Args, Ret, SideEffects, GasPriceTier
	...
	{ Instruction::AESENCODE,	{ "AESENCODE",		0, 2, 1, true, Tier::Special } },
	{ Instruction::AESDECODE,	{ "AESDECODE",		0, 2, 1, true, Tier::Special } },
